...
const razorpayKeyId = process.env.RAZORPAY_KEY_ID || process.env.RAZORPAY_ID
      ...
      providers: [
        {
          ...
          options: {
            ...
            razorpay_account:
              process.env.RAZORPAY_ACCOUNT && process.env.RAZORPAY_ACCOUNT.trim()
                ? process.env.RAZORPAY_ACCOUNT.trim()
                : undefined,
            webhook_secret:
